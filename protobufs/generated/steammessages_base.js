...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgProtoBufHeader = (function() {
         ...
         * @member {Uint8Array|null|undefined} ip_v6
         * @memberof CMsgProtoBufHeader
         * @instance
         */
        CMsgProtoBufHeader.prototype.ip_v6 = null;
    ...
    $root.CCDDBAppDetailCommon = (function() {
        ...
        /**
         * CCDDBAppDetailCommon app_type.
         * @member {number} app_type
         * @memberof CCDDBAppDetailCommon
         * @instance
         */
    ...
    $root.CCommunity_ClanAnnouncementInfo = (function() {
        ...
        /**
         * CCommunity_ClanAnnouncementInfo ban_check_result.
         * @member {EBanContentCheckResult} ban_check_result
         * @memberof CCommunity_ClanAnnouncementInfo
         * @instance
         */
        ...
        CCommunity_ClanAnnouncementInfo.fromObject = function fromObject(object) {
            ...
            switch (object.ban_check_result) {
            default:
                if (typeof object.ban_check_result === "number") {
                    message.ban_check_result = object.ban_check_result;
                    break;
                }
                break;
            case "k_EBanContentCheckResult_NotScanned":
            case 0:
                message.ban_check_result = 0;
                break;
            case "k_EBanContentCheckResult_Reset":
            case 1:
                message.ban_check_result = 1;
                break;
            case "k_EBanContentCheckResult_NeedsChecking":
            case 2:
                message.ban_check_result = 2;
                break;
            case "k_EBanContentCheckResult_VeryUnlikely":
            case 5:
                message.ban_check_result = 5;
                break;
            case "k_EBanContentCheckResult_Unlikely":
            case 30:
                message.ban_check_result = 30;
                break;
            case "k_EBanContentCheckResult_Possible":
            case 50:
                message.ban_check_result = 50;
                break;
            case "k_EBanContentCheckResult_Likely":
            case 75:
                message.ban_check_result = 75;
                break;
    ...
    $root.google = (function() {
        ...
        google.protobuf = (function() {
            ...
            protobuf.FieldOptions = (function() {
                 ...
                 * @property {boolean|null} [".allow_field_named_steam_id"] FieldOptions .allow_field_named_steam_id
                 */
                ...
                /**
                 * FieldOptions .allow_field_named_steam_id.
                 * @member {boolean} .allow_field_named_steam_id
                 * @memberof google.protobuf.FieldOptions
                 * @instance
                 */
                FieldOptions.prototype[".allow_field_named_steam_id"] = false;
                ...
                FieldOptions.encode = function encode(message, writer) {
                    ...
                    if (message[".allow_field_named_steam_id"] != null && Object.hasOwnProperty.call(message, ".allow_field_named_steam_id"))
                        writer.uint32(/* id 50024, wireType 0 =*/400192).bool(message[".allow_field_named_steam_id"]);
                    return writer;
                };
                ...
                FieldOptions.decode = function decode(reader, length, error) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 50024: {
                                message[".allow_field_named_steam_id"] = reader.bool();
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                FieldOptions.fromObject = function fromObject(object) {
                    ...
                    if (object[".allow_field_named_steam_id"] != null)
                        message[".allow_field_named_steam_id"] = Boolean(object[".allow_field_named_steam_id"]);
                    return message;
                };
