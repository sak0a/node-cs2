...
(function(global, factory) { /* global define, require, module */
    ...
    $root.MLWeaponState = (function() {
         ...
         * @member {number} ammo_clip
         * @memberof MLWeaponState
         * @instance
         */
        MLWeaponState.prototype.ammo_clip = 0;
    
        /**
         * MLWeaponState ammo_clip_max.
         * @member {number} ammo_clip_max
         * @memberof MLWeaponState
         * @instance
         */
        MLWeaponState.prototype.ammo_clip_max = 0;
    
        /**
         * MLWeaponState ammo_reserve.
         * @member {number} ammo_reserve
         * @memberof MLWeaponState
         * @instance
         */
        MLWeaponState.prototype.ammo_reserve = 0;
         ...
         * @instance
         */
        MLWeaponState.prototype.state = "";
    
        /**
         * MLWeaponState recoil_index.
         * @member {number} recoil_index
         * @memberof MLWeaponState
         * @instance
         */
        MLWeaponState.prototype.recoil_index = 0;
         ...
         * @static
         * @param {IMLWeaponState=} [properties] Properties to set
         * @returns {MLWeaponState} MLWeaponState instance
         */
        MLWeaponState.create = function create(properties) {
            return new MLWeaponState(properties);
        };
         ...
         * @memberof MLWeaponState
         * @static
         * @param {IMLWeaponState} message MLWeaponState message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MLWeaponState.encode = function encode(message, writer) {
            ...
            if (message.ammo_clip != null && Object.hasOwnProperty.call(message, "ammo_clip"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.ammo_clip);
            if (message.ammo_clip_max != null && Object.hasOwnProperty.call(message, "ammo_clip_max"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.ammo_clip_max);
            if (message.ammo_reserve != null && Object.hasOwnProperty.call(message, "ammo_reserve"))
                writer.uint32(/* id 6, wireType 0 =*/48).int32(message.ammo_reserve);
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MLWeaponState.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        MLWeaponState.fromObject = function fromObject(object) {
            ...
            if (object.ammo_clip != null)
                message.ammo_clip = object.ammo_clip | 0;
            if (object.ammo_clip_max != null)
                message.ammo_clip_max = object.ammo_clip_max | 0;
            if (object.ammo_reserve != null)
                message.ammo_reserve = object.ammo_reserve | 0;
         ...
         * @memberof MLWeaponState
         * @static
         * @param {MLWeaponState} message MLWeaponState
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MLWeaponState.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                object.index = 0;
                object.name = "";
                object.type = options.enums === String ? "EWT_Knife" : 0;
                object.ammo_clip = 0;
                object.ammo_clip_max = 0;
                object.ammo_reserve = 0;
                object.state = "";
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MLWeaponState.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MLWeaponState.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/MLWeaponState";
        };
    
        return MLWeaponState;
    })();
    
    $root.MLPlayerState = (function() {
    
        /**
         * Properties of a MLPlayerState.
         * @exports IMLPlayerState
         * @interface IMLPlayerState
         * @property {number|null} [account_id] MLPlayerState account_id
         * @property {number|null} [player_slot] MLPlayerState player_slot
         * @property {number|null} [entindex] MLPlayerState entindex
         * @property {string|null} [name] MLPlayerState name
         * @property {string|null} [clan] MLPlayerState clan
         * @property {ETeam|null} [team] MLPlayerState team
         * @property {ICMsgVector|null} [abspos] MLPlayerState abspos
         * @property {ICMsgQAngle|null} [eyeangle] MLPlayerState eyeangle
         * @property {ICMsgVector|null} [eyeangle_fwd] MLPlayerState eyeangle_fwd
         * @property {number|null} [health] MLPlayerState health
         * @property {number|null} [armor] MLPlayerState armor
         * @property {number|null} [flashed] MLPlayerState flashed
         * @property {number|null} [smoked] MLPlayerState smoked
         * @property {number|null} [money] MLPlayerState money
         * @property {number|null} [round_kills] MLPlayerState round_kills
         * @property {number|null} [round_killhs] MLPlayerState round_killhs
         * @property {number|null} [burning] MLPlayerState burning
         * @property {boolean|null} [helmet] MLPlayerState helmet
         * @property {boolean|null} [defuse_kit] MLPlayerState defuse_kit
         * @property {Array.<IMLWeaponState>|null} [weapons] MLPlayerState weapons
         */
    
        /**
         * Constructs a new MLPlayerState.
         * @exports MLPlayerState
         * @classdesc Represents a MLPlayerState.
         * @implements IMLPlayerState
         * @constructor
         * @param {IMLPlayerState=} [properties] Properties to set
         */
        function MLPlayerState(properties) {
            this.weapons = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * MLPlayerState account_id.
         * @member {number} account_id
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.account_id = 0;
    
        /**
         * MLPlayerState player_slot.
         * @member {number} player_slot
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.player_slot = -1;
         ...
         * @instance
         */
        MLPlayerState.prototype.entindex = 0;
         ...
         * @instance
         */
        MLPlayerState.prototype.team = 0;
    
        /**
         * MLPlayerState abspos.
         * @member {ICMsgVector|null|undefined} abspos
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.abspos = null;
    
        /**
         * MLPlayerState eyeangle.
         * @member {ICMsgQAngle|null|undefined} eyeangle
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.eyeangle = null;
    
        /**
         * MLPlayerState eyeangle_fwd.
         * @member {ICMsgVector|null|undefined} eyeangle_fwd
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.eyeangle_fwd = null;
         ...
         * @instance
         */
        MLPlayerState.prototype.health = 0;
         ...
         * @instance
         */
        MLPlayerState.prototype.armor = 0;
    
        /**
         * MLPlayerState flashed.
         * @member {number} flashed
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.flashed = 0;
    
        /**
         * MLPlayerState smoked.
         * @member {number} smoked
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.smoked = 0;
         ...
         * @instance
         */
        MLPlayerState.prototype.money = 0;
    
        /**
         * MLPlayerState round_kills.
         * @member {number} round_kills
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.round_kills = 0;
    
        /**
         * MLPlayerState round_killhs.
         * @member {number} round_killhs
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.round_killhs = 0;
    
        /**
         * MLPlayerState burning.
         * @member {number} burning
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.burning = 0;
    
        /**
         * MLPlayerState helmet.
         * @member {boolean} helmet
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.helmet = false;
    
        /**
         * MLPlayerState defuse_kit.
         * @member {boolean} defuse_kit
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.defuse_kit = false;
    
        /**
         * MLPlayerState weapons.
         * @member {Array.<IMLWeaponState>} weapons
         * @memberof MLPlayerState
         * @instance
         */
        MLPlayerState.prototype.weapons = $util.emptyArray;
         ...
         * @static
         * @param {IMLPlayerState=} [properties] Properties to set
         * @returns {MLPlayerState} MLPlayerState instance
         */
        MLPlayerState.create = function create(properties) {
            return new MLPlayerState(properties);
        };
         ...
         * @memberof MLPlayerState
         * @static
         * @param {IMLPlayerState} message MLPlayerState message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MLPlayerState.encode = function encode(message, writer) {
            ...
            if (message.player_slot != null && Object.hasOwnProperty.call(message, "player_slot"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.player_slot);
            ...
            if (message.clan != null && Object.hasOwnProperty.call(message, "clan"))
                writer.uint32(/* id 5, wireType 2 =*/42).string(message.clan);
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MLPlayerState.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        MLPlayerState.fromObject = function fromObject(object) {
            ...
            if (object.name != null)
                message.name = String(object.name);
            if (object.clan != null)
                message.clan = String(object.clan);
            switch (object.team) {
            default:
            ...
            if (object.flashed != null)
                message.flashed = Number(object.flashed);
            if (object.smoked != null)
                message.smoked = Number(object.smoked);
            if (object.money != null)
                message.money = object.money | 0;
            if (object.round_kills != null)
                message.round_kills = object.round_kills | 0;
            if (object.round_killhs != null)
                message.round_killhs = object.round_killhs | 0;
            if (object.burning != null)
                message.burning = Number(object.burning);
            if (object.helmet != null)
                message.helmet = Boolean(object.helmet);
            if (object.defuse_kit != null)
                message.defuse_kit = Boolean(object.defuse_kit);
            if (object.weapons) {
         ...
         * @memberof MLPlayerState
         * @static
         * @param {MLPlayerState} message MLPlayerState
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MLPlayerState.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.name = "";
                object.clan = "";
                object.team = options.enums === String ? "ET_Unknown" : 0;
                object.abspos = null;
                object.eyeangle = null;
                object.eyeangle_fwd = null;
                object.health = 0;
                object.armor = 0;
                object.flashed = 0;
                object.smoked = 0;
                object.money = 0;
                object.round_kills = 0;
                object.round_killhs = 0;
                object.burning = 0;
                object.helmet = false;
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MLPlayerState.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MLPlayerState.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/MLPlayerState";
        };
    
        return MLPlayerState;
    })();
    
    $root.MLGameState = (function() {
    
        /**
         * Properties of a MLGameState.
         * @exports IMLGameState
         * @interface IMLGameState
         * @property {IMLMatchState|null} [match] MLGameState match
         * @property {IMLRoundState|null} [round] MLGameState round
         * @property {Array.<IMLPlayerState>|null} [players] MLGameState players
         */
    
        /**
         * Constructs a new MLGameState.
         * @exports MLGameState
         * @classdesc Represents a MLGameState.
         * @implements IMLGameState
         * @constructor
         * @param {IMLGameState=} [properties] Properties to set
         */
        function MLGameState(properties) {
            this.players = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * MLGameState match.
         * @member {IMLMatchState|null|undefined} match
         * @memberof MLGameState
         * @instance
         */
        MLGameState.prototype.match = null;
    
        /**
         * MLGameState round.
         * @member {IMLRoundState|null|undefined} round
         * @memberof MLGameState
         * @instance
         */
        MLGameState.prototype.round = null;
    
        /**
         * MLGameState players.
         * @member {Array.<IMLPlayerState>} players
         * @memberof MLGameState
         * @instance
         */
        MLGameState.prototype.players = $util.emptyArray;
         ...
         * @static
         * @param {IMLGameState=} [properties] Properties to set
         * @returns {MLGameState} MLGameState instance
         */
        MLGameState.create = function create(properties) {
            return new MLGameState(properties);
        };
         ...
         * @memberof MLGameState
         * @static
         * @param {IMLGameState} message MLGameState message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MLGameState.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @memberof MLGameState
         * @static
         * @param {MLGameState} message MLGameState
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MLGameState.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MLGameState.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/MLGameState";
        };
    
        return MLGameState;
    })();
    
    $root.MLDemoHeader = (function() {
    
        /**
         * Properties of a MLDemoHeader.
         * @exports IMLDemoHeader
         * @interface IMLDemoHeader
         * @property {string|null} [map_name] MLDemoHeader map_name
         * @property {number|null} [tick_rate] MLDemoHeader tick_rate
         * @property {number|null} [version] MLDemoHeader version
         * @property {number|null} [steam_universe] MLDemoHeader steam_universe
         */
    
        /**
         * Constructs a new MLDemoHeader.
         * @exports MLDemoHeader
         * @classdesc Represents a MLDemoHeader.
         * @implements IMLDemoHeader
         * @constructor
         * @param {IMLDemoHeader=} [properties] Properties to set
         */
         ...
         * @memberof MLDemoHeader
         * @instance
         */
        MLDemoHeader.prototype.map_name = "";
    
        /**
         * MLDemoHeader tick_rate.
         * @member {number} tick_rate
         * @memberof MLDemoHeader
         * @instance
         */
        MLDemoHeader.prototype.tick_rate = 0;
         ...
         * @instance
         */
        MLDemoHeader.prototype.version = 0;
    
        /**
         * MLDemoHeader steam_universe.
         * @member {number} steam_universe
         * @memberof MLDemoHeader
         * @instance
         */
        MLDemoHeader.prototype.steam_universe = 0;
         ...
         * @static
         * @param {IMLDemoHeader=} [properties] Properties to set
         * @returns {MLDemoHeader} MLDemoHeader instance
         */
        MLDemoHeader.create = function create(properties) {
            return new MLDemoHeader(properties);
        };
         ...
         * @memberof MLDemoHeader
         * @static
         * @param {IMLDemoHeader} message MLDemoHeader message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MLDemoHeader.encode = function encode(message, writer) {
            ...
            if (message.tick_rate != null && Object.hasOwnProperty.call(message, "tick_rate"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.tick_rate);
            ...
            if (message.steam_universe != null && Object.hasOwnProperty.call(message, "steam_universe"))
                writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.steam_universe);
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MLDemoHeader.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        MLDemoHeader.fromObject = function fromObject(object) {
            ...
            if (object.steam_universe != null)
                message.steam_universe = object.steam_universe >>> 0;
            return message;
        };
         ...
         * @memberof MLDemoHeader
         * @static
         * @param {MLDemoHeader} message MLDemoHeader
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MLDemoHeader.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MLDemoHeader.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/MLDemoHeader";
        };
    
        return MLDemoHeader;
    })();
    
    $root.MLTick = (function() {
    
        /**
         * Properties of a MLTick.
         * @exports IMLTick
         * @interface IMLTick
         * @property {number|null} [tick_count] MLTick tick_count
         * @property {IMLGameState|null} [state] MLTick state
         * @property {Array.<IMLEvent>|null} [events] MLTick events
         */
    
        /**
         * Constructs a new MLTick.
         * @exports MLTick
         * @classdesc Represents a MLTick.
         * @implements IMLTick
         * @constructor
         * @param {IMLTick=} [properties] Properties to set
         */
        function MLTick(properties) {
            this.events = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * MLTick tick_count.
         * @member {number} tick_count
         * @memberof MLTick
         * @instance
         */
        MLTick.prototype.tick_count = 0;
    
        /**
         * MLTick state.
         * @member {IMLGameState|null|undefined} state
         * @memberof MLTick
         * @instance
         */
        MLTick.prototype.state = null;
    
        /**
         * MLTick events.
         * @member {Array.<IMLEvent>} events
         * @memberof MLTick
         * @instance
         */
        MLTick.prototype.events = $util.emptyArray;
         ...
         * @static
         * @param {IMLTick=} [properties] Properties to set
         * @returns {MLTick} MLTick instance
         */
        MLTick.create = function create(properties) {
            return new MLTick(properties);
        };
         ...
         * @memberof MLTick
         * @static
         * @param {IMLTick} message MLTick message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MLTick.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {Object.<string,*>} JSON object
         */
        MLTick.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        MLTick.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/MLTick";
        };
    
        return MLTick;
    })();
    
    $root.VacNetShot = (function() {
    
        /**
         * Properties of a VacNetShot.
         * @exports IVacNetShot
         * @interface IVacNetShot
         * @property {number|Long|null} [steamid_player] VacNetShot steamid_player
         * @property {number|null} [round_number] VacNetShot round_number
         * @property {number|null} [hit_type] VacNetShot hit_type
         * @property {number|null} [weapon_type] VacNetShot weapon_type
         * @property {number|null} [distance_to_hurt_target] VacNetShot distance_to_hurt_target
         * @property {Array.<number>|null} [delta_yaw_window] VacNetShot delta_yaw_window
         * @property {Array.<number>|null} [delta_pitch_window] VacNetShot delta_pitch_window
         */
    
        /**
         * Constructs a new VacNetShot.
         * @exports VacNetShot
         * @classdesc Represents a VacNetShot.
         * @implements IVacNetShot
         * @constructor
         * @param {IVacNetShot=} [properties] Properties to set
         */
        function VacNetShot(properties) {
            this.delta_yaw_window = [];
        ...
        /**
         * VacNetShot steamid_player.
         * @member {number|Long} steamid_player
         * @memberof VacNetShot
         * @instance
         */
         ...
         * @member {number} round_number
         * @memberof VacNetShot
         * @instance
         */
        VacNetShot.prototype.round_number = 0;
         ...
         * @instance
         */
        VacNetShot.prototype.hit_type = 0;
    
        /**
         * VacNetShot weapon_type.
         * @member {number} weapon_type
         * @memberof VacNetShot
         * @instance
         */
        VacNetShot.prototype.weapon_type = 0;
    
        /**
         * VacNetShot distance_to_hurt_target.
         * @member {number} distance_to_hurt_target
         * @memberof VacNetShot
         * @instance
         */
        VacNetShot.prototype.distance_to_hurt_target = 0;
    
        /**
         * VacNetShot delta_yaw_window.
         * @member {Array.<number>} delta_yaw_window
         * @memberof VacNetShot
         * @instance
         */
        VacNetShot.prototype.delta_yaw_window = $util.emptyArray;
    
        /**
         * VacNetShot delta_pitch_window.
         * @member {Array.<number>} delta_pitch_window
         * @memberof VacNetShot
         * @instance
         */
        VacNetShot.prototype.delta_pitch_window = $util.emptyArray;
         ...
         * @static
         * @param {IVacNetShot=} [properties] Properties to set
         * @returns {VacNetShot} VacNetShot instance
         */
        VacNetShot.create = function create(properties) {
            return new VacNetShot(properties);
        };
         ...
         * @memberof VacNetShot
         * @static
         * @param {IVacNetShot} message VacNetShot message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        VacNetShot.encode = function encode(message, writer) {
            ...
            if (message.round_number != null && Object.hasOwnProperty.call(message, "round_number"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.round_number);
            if (message.hit_type != null && Object.hasOwnProperty.call(message, "hit_type"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.hit_type);
            if (message.weapon_type != null && Object.hasOwnProperty.call(message, "weapon_type"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.weapon_type);
            if (message.distance_to_hurt_target != null && Object.hasOwnProperty.call(message, "distance_to_hurt_target"))
                writer.uint32(/* id 5, wireType 5 =*/45).float(message.distance_to_hurt_target);
            if (message.delta_yaw_window != null && message.delta_yaw_window.length)
                for (var i = 0; i < message.delta_yaw_window.length; ++i)
                    writer.uint32(/* id 6, wireType 5 =*/53).float(message.delta_yaw_window[i]);
            if (message.delta_pitch_window != null && message.delta_pitch_window.length)
                for (var i = 0; i < message.delta_pitch_window.length; ++i)
                    writer.uint32(/* id 7, wireType 5 =*/61).float(message.delta_pitch_window[i]);
            return writer;
        };
        ...
        VacNetShot.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1: {
                        message.steamid_player = reader.fixed64();
                        break;
                    }
                case 2: {
                ...
                case 7: {
                        if (!(message.delta_pitch_window && message.delta_pitch_window.length))
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VacNetShot.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        VacNetShot.verify = function verify(message) {
            ...
            if (message.delta_pitch_window != null && message.hasOwnProperty("delta_pitch_window")) {
                ...
                for (var i = 0; i < message.delta_pitch_window.length; ++i)
                    if (typeof message.delta_pitch_window[i] !== "number")
                        return "delta_pitch_window: number[] expected";
            }
            return null;
        };
        ...
        VacNetShot.fromObject = function fromObject(object) {
            ...
            if (object.weapon_type != null)
                message.weapon_type = object.weapon_type | 0;
            if (object.distance_to_hurt_target != null)
                message.distance_to_hurt_target = Number(object.distance_to_hurt_target);
            if (object.delta_yaw_window) {
                if (!Array.isArray(object.delta_yaw_window))
                    throw TypeError(".VacNetShot.delta_yaw_window: array expected");
                message.delta_yaw_window = [];
                for (var i = 0; i < object.delta_yaw_window.length; ++i)
                    message.delta_yaw_window[i] = Number(object.delta_yaw_window[i]);
            }
            if (object.delta_pitch_window) {
                if (!Array.isArray(object.delta_pitch_window))
                    throw TypeError(".VacNetShot.delta_pitch_window: array expected");
                message.delta_pitch_window = [];
                for (var i = 0; i < object.delta_pitch_window.length; ++i)
                    message.delta_pitch_window[i] = Number(object.delta_pitch_window[i]);
            }
            return message;
        };
         ...
         * @memberof VacNetShot
         * @static
         * @param {VacNetShot} message VacNetShot
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        VacNetShot.toObject = function toObject(message, options) {
            ...
            if (message.delta_yaw_window && message.delta_yaw_window.length) {
                object.delta_yaw_window = [];
                for (var j = 0; j < message.delta_yaw_window.length; ++j)
                    object.delta_yaw_window[j] = options.json && !isFinite(message.delta_yaw_window[j]) ? String(message.delta_yaw_window[j]) : message.delta_yaw_window[j];
            }
            if (message.delta_pitch_window && message.delta_pitch_window.length) {
                object.delta_pitch_window = [];
                for (var j = 0; j < message.delta_pitch_window.length; ++j)
                    object.delta_pitch_window[j] = options.json && !isFinite(message.delta_pitch_window[j]) ? String(message.delta_pitch_window[j]) : message.delta_pitch_window[j];
            }
            return object;
        };
         ...
         * @returns {Object.<string,*>} JSON object
         */
        VacNetShot.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
         ...
         * @returns {string} The default type url
         */
        VacNetShot.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/VacNetShot";
        };
