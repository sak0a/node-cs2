...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgTEFireBullets = (function() {
        ...
        CMsgTEFireBullets.Extra = (function() {
    
            /**
             * Properties of an Extra.
             * @memberof CMsgTEFireBullets
             * @interface IExtra
             * @property {ICMsgQAngle|null} [aim_punch] Extra aim_punch
             * @property {number|null} [attack_tick_count] Extra attack_tick_count
             * @property {number|null} [attack_tick_frac] Extra attack_tick_frac
             * @property {number|null} [render_tick_count] Extra render_tick_count
             * @property {number|null} [render_tick_frac] Extra render_tick_frac
             * @property {number|null} [inaccuracy_move] Extra inaccuracy_move
             * @property {number|null} [inaccuracy_air] Extra inaccuracy_air
             * @property {number|null} [type] Extra type
             */
             ...
             * @implements IExtra
             * @constructor
             * @param {CMsgTEFireBullets.IExtra=} [properties] Properties to set
             */
            ...
            /**
             * Extra aim_punch.
             * @member {ICMsgQAngle|null|undefined} aim_punch
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.aim_punch = null;
    
            /**
             * Extra attack_tick_count.
             * @member {number} attack_tick_count
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.attack_tick_count = 0;
    
            /**
             * Extra attack_tick_frac.
             * @member {number} attack_tick_frac
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.attack_tick_frac = 0;
    
            /**
             * Extra render_tick_count.
             * @member {number} render_tick_count
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.render_tick_count = 0;
    
            /**
             * Extra render_tick_frac.
             * @member {number} render_tick_frac
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.render_tick_frac = 0;
    
            /**
             * Extra inaccuracy_move.
             * @member {number} inaccuracy_move
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.inaccuracy_move = 0;
    
            /**
             * Extra inaccuracy_air.
             * @member {number} inaccuracy_air
             * @memberof CMsgTEFireBullets.Extra
             * @instance
             */
            Extra.prototype.inaccuracy_air = 0;
             ...
             * @static
             * @param {CMsgTEFireBullets.IExtra=} [properties] Properties to set
             * @returns {CMsgTEFireBullets.Extra} Extra instance
             */
            ...
            /**
             * Encodes the specified Extra message. Does not implicitly {@link CMsgTEFireBullets.Extra.verify|verify} messages.
             * @function encode
             * @memberof CMsgTEFireBullets.Extra
             * @static
             * @param {CMsgTEFireBullets.IExtra} message Extra message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            Extra.encode = function encode(message, writer) {
                ...
                if (message.attack_tick_frac != null && Object.hasOwnProperty.call(message, "attack_tick_frac"))
                    writer.uint32(/* id 3, wireType 5 =*/29).float(message.attack_tick_frac);
                ...
                if (message.render_tick_frac != null && Object.hasOwnProperty.call(message, "render_tick_frac"))
                    writer.uint32(/* id 5, wireType 5 =*/45).float(message.render_tick_frac);
                if (message.inaccuracy_move != null && Object.hasOwnProperty.call(message, "inaccuracy_move"))
                    writer.uint32(/* id 6, wireType 5 =*/53).float(message.inaccuracy_move);
                if (message.inaccuracy_air != null && Object.hasOwnProperty.call(message, "inaccuracy_air"))
                    writer.uint32(/* id 7, wireType 5 =*/61).float(message.inaccuracy_air);
            ...
            /**
             * Encodes the specified Extra message, length delimited. Does not implicitly {@link CMsgTEFireBullets.Extra.verify|verify} messages.
             * @function encodeDelimited
             * @memberof CMsgTEFireBullets.Extra
             * @static
             * @param {CMsgTEFireBullets.IExtra} message Extra message or plain object to encode
            ...
            Extra.fromObject = function fromObject(object) {
                ...
                if (object.attack_tick_frac != null)
                    message.attack_tick_frac = Number(object.attack_tick_frac);
                if (object.render_tick_count != null)
                    message.render_tick_count = object.render_tick_count | 0;
                if (object.render_tick_frac != null)
                    message.render_tick_frac = Number(object.render_tick_frac);
                if (object.inaccuracy_move != null)
                    message.inaccuracy_move = Number(object.inaccuracy_move);
                if (object.inaccuracy_air != null)
                    message.inaccuracy_air = Number(object.inaccuracy_air);
                if (object.type != null)
             ...
             * @memberof CMsgTEFireBullets.Extra
             * @static
             * @param {CMsgTEFireBullets.Extra} message Extra
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            Extra.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.attack_tick_count = 0;
                    object.attack_tick_frac = 0;
                    object.render_tick_count = 0;
                    object.render_tick_frac = 0;
                    object.inaccuracy_move = 0;
            ...
            Extra.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/CMsgTEFireBullets.Extra";
            };
    ...
    $root.CMsgPlayerBulletHit = (function() {
    
        /**
         * Properties of a CMsgPlayerBulletHit.
         * @exports ICMsgPlayerBulletHit
         * @interface ICMsgPlayerBulletHit
         * @property {number|null} [attacker_slot] CMsgPlayerBulletHit attacker_slot
         * @property {number|null} [victim_slot] CMsgPlayerBulletHit victim_slot
         * @property {ICMsgVector|null} [victim_pos] CMsgPlayerBulletHit victim_pos
         * @property {number|null} [hit_group] CMsgPlayerBulletHit hit_group
        ...
        /**
         * Constructs a new CMsgPlayerBulletHit.
         * @exports CMsgPlayerBulletHit
         * @classdesc Represents a CMsgPlayerBulletHit.
         * @implements ICMsgPlayerBulletHit
         * @constructor
         * @param {ICMsgPlayerBulletHit=} [properties] Properties to set
         */
        ...
        /**
         * CMsgPlayerBulletHit attacker_slot.
         * @member {number} attacker_slot
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
        CMsgPlayerBulletHit.prototype.attacker_slot = -1;
    
        /**
         * CMsgPlayerBulletHit victim_slot.
         * @member {number} victim_slot
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
        CMsgPlayerBulletHit.prototype.victim_slot = -1;
    
        /**
         * CMsgPlayerBulletHit victim_pos.
         * @member {ICMsgVector|null|undefined} victim_pos
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
        CMsgPlayerBulletHit.prototype.victim_pos = null;
    
        /**
         * CMsgPlayerBulletHit hit_group.
         * @member {number} hit_group
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
        CMsgPlayerBulletHit.prototype.hit_group = 0;
    
        /**
         * CMsgPlayerBulletHit damage.
         * @member {number} damage
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
        CMsgPlayerBulletHit.prototype.damage = 0;
    
        /**
         * CMsgPlayerBulletHit penetration_count.
         * @member {number} penetration_count
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
        CMsgPlayerBulletHit.prototype.penetration_count = 0;
    
        /**
         * CMsgPlayerBulletHit is_kill.
         * @member {boolean} is_kill
         * @memberof CMsgPlayerBulletHit
         * @instance
         */
         ...
         * @static
         * @param {ICMsgPlayerBulletHit=} [properties] Properties to set
         * @returns {CMsgPlayerBulletHit} CMsgPlayerBulletHit instance
         */
        CMsgPlayerBulletHit.create = function create(properties) {
            return new CMsgPlayerBulletHit(properties);
        };
    
        /**
         * Encodes the specified CMsgPlayerBulletHit message. Does not implicitly {@link CMsgPlayerBulletHit.verify|verify} messages.
         * @function encode
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {ICMsgPlayerBulletHit} message CMsgPlayerBulletHit message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CMsgPlayerBulletHit message, length delimited. Does not implicitly {@link CMsgPlayerBulletHit.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {ICMsgPlayerBulletHit} message CMsgPlayerBulletHit message or plain object to encode
        ...
        /**
         * Decodes a CMsgPlayerBulletHit message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
        ...
        /**
         * Decodes a CMsgPlayerBulletHit message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgPlayerBulletHit.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgPlayerBulletHit message.
         * @function verify
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgPlayerBulletHit message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        CMsgPlayerBulletHit.fromObject = function fromObject(object) {
            ...
            if (object.penetration_count != null)
        ...
        /**
         * Creates a plain object from a CMsgPlayerBulletHit message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {CMsgPlayerBulletHit} message CMsgPlayerBulletHit
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CMsgPlayerBulletHit.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.victim_slot = -1;
                object.victim_pos = null;
                object.hit_group = 0;
                object.damage = 0;
        ...
        /**
         * Converts this CMsgPlayerBulletHit to JSON.
         * @function toJSON
         * @memberof CMsgPlayerBulletHit
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgPlayerBulletHit.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    
        /**
         * Gets the default type url for CMsgPlayerBulletHit
         * @function getTypeUrl
         * @memberof CMsgPlayerBulletHit
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        CMsgPlayerBulletHit.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgPlayerBulletHit";
        };
