...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CSGOInterpolationInfoPB = (function() {
         ...
         * @property {number|null} [src_tick] CSGOInterpolationInfoPB src_tick
         * @property {number|null} [dst_tick] CSGOInterpolationInfoPB dst_tick
        ...
        /**
         * CSGOInterpolationInfoPB src_tick.
         * @member {number} src_tick
         * @memberof CSGOInterpolationInfoPB
         * @instance
         */
        CSGOInterpolationInfoPB.prototype.src_tick = -1;
    
        /**
         * CSGOInterpolationInfoPB dst_tick.
         * @member {number} dst_tick
         * @memberof CSGOInterpolationInfoPB
         * @instance
         */
        CSGOInterpolationInfoPB.prototype.dst_tick = -1;
        ...
        CSGOInterpolationInfoPB.encode = function encode(message, writer) {
            ...
            if (message.dst_tick != null && Object.hasOwnProperty.call(message, "dst_tick"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.dst_tick);
        ...
        CSGOInterpolationInfoPB.fromObject = function fromObject(object) {
            ...
            if (object.dst_tick != null)
                message.dst_tick = object.dst_tick | 0;
            if (object.frac != null)
    ...
    $root.CSGOInterpolationInfoPB_CL = (function() {
    
        /**
         * Properties of a CSGOInterpolationInfoPB_CL.
         * @exports ICSGOInterpolationInfoPB_CL
         * @interface ICSGOInterpolationInfoPB_CL
         * @property {number|null} [frac] CSGOInterpolationInfoPB_CL frac
         */
    
        /**
         * Constructs a new CSGOInterpolationInfoPB_CL.
         * @exports CSGOInterpolationInfoPB_CL
         * @classdesc Represents a CSGOInterpolationInfoPB_CL.
         * @implements ICSGOInterpolationInfoPB_CL
         * @constructor
         * @param {ICSGOInterpolationInfoPB_CL=} [properties] Properties to set
         */
        ...
        /**
         * CSGOInterpolationInfoPB_CL frac.
         * @member {number} frac
         * @memberof CSGOInterpolationInfoPB_CL
         * @instance
         */
        CSGOInterpolationInfoPB_CL.prototype.frac = 0;
    
        /**
         * Creates a new CSGOInterpolationInfoPB_CL instance using the specified properties.
         * @function create
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {ICSGOInterpolationInfoPB_CL=} [properties] Properties to set
         * @returns {CSGOInterpolationInfoPB_CL} CSGOInterpolationInfoPB_CL instance
         */
        CSGOInterpolationInfoPB_CL.create = function create(properties) {
            return new CSGOInterpolationInfoPB_CL(properties);
        };
    
        /**
         * Encodes the specified CSGOInterpolationInfoPB_CL message. Does not implicitly {@link CSGOInterpolationInfoPB_CL.verify|verify} messages.
         * @function encode
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {ICSGOInterpolationInfoPB_CL} message CSGOInterpolationInfoPB_CL message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CSGOInterpolationInfoPB_CL message, length delimited. Does not implicitly {@link CSGOInterpolationInfoPB_CL.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {ICSGOInterpolationInfoPB_CL} message CSGOInterpolationInfoPB_CL message or plain object to encode
        ...
        /**
         * Decodes a CSGOInterpolationInfoPB_CL message from the specified reader or buffer.
         * @function decode
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
        ...
        /**
         * Decodes a CSGOInterpolationInfoPB_CL message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CSGOInterpolationInfoPB_CL.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CSGOInterpolationInfoPB_CL message.
         * @function verify
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CSGOInterpolationInfoPB_CL message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CSGOInterpolationInfoPB_CL message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {CSGOInterpolationInfoPB_CL} message CSGOInterpolationInfoPB_CL
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CSGOInterpolationInfoPB_CL to JSON.
         * @function toJSON
         * @memberof CSGOInterpolationInfoPB_CL
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CSGOInterpolationInfoPB_CL.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    
        /**
         * Gets the default type url for CSGOInterpolationInfoPB_CL
         * @function getTypeUrl
         * @memberof CSGOInterpolationInfoPB_CL
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        CSGOInterpolationInfoPB_CL.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CSGOInterpolationInfoPB_CL";
        };
    ...
    $root.CSGOInputHistoryEntryPB = (function() {
         ...
         * @property {ICMsgQAngle|null} [view_angles] CSGOInputHistoryEntryPB view_angles
         * @property {number|null} [render_tick_count] CSGOInputHistoryEntryPB render_tick_count
         * @property {number|null} [render_tick_fraction] CSGOInputHistoryEntryPB render_tick_fraction
         * @property {number|null} [player_tick_count] CSGOInputHistoryEntryPB player_tick_count
         * @property {number|null} [player_tick_fraction] CSGOInputHistoryEntryPB player_tick_fraction
         * @property {ICSGOInterpolationInfoPB_CL|null} [cl_interp] CSGOInputHistoryEntryPB cl_interp
         * @property {ICSGOInterpolationInfoPB|null} [sv_interp0] CSGOInputHistoryEntryPB sv_interp0
         * @property {ICSGOInterpolationInfoPB|null} [sv_interp1] CSGOInputHistoryEntryPB sv_interp1
         * @property {ICSGOInterpolationInfoPB|null} [player_interp] CSGOInputHistoryEntryPB player_interp
         * @property {number|null} [frame_number] CSGOInputHistoryEntryPB frame_number
         * @property {number|null} [target_ent_index] CSGOInputHistoryEntryPB target_ent_index
         * @property {ICMsgVector|null} [shoot_position] CSGOInputHistoryEntryPB shoot_position
         * @property {ICMsgVector|null} [target_head_pos_check] CSGOInputHistoryEntryPB target_head_pos_check
         * @property {ICMsgVector|null} [target_abs_pos_check] CSGOInputHistoryEntryPB target_abs_pos_check
         * @property {ICMsgQAngle|null} [target_abs_ang_check] CSGOInputHistoryEntryPB target_abs_ang_check
         */
        ...
        /**
         * CSGOInputHistoryEntryPB view_angles.
         * @member {ICMsgQAngle|null|undefined} view_angles
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.view_angles = null;
    
        /**
         * CSGOInputHistoryEntryPB render_tick_count.
         * @member {number} render_tick_count
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.render_tick_count = 0;
    
        /**
         * CSGOInputHistoryEntryPB render_tick_fraction.
         * @member {number} render_tick_fraction
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.render_tick_fraction = 0;
    
        /**
         * CSGOInputHistoryEntryPB player_tick_count.
         * @member {number} player_tick_count
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.player_tick_count = 0;
    
        /**
         * CSGOInputHistoryEntryPB player_tick_fraction.
         * @member {number} player_tick_fraction
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.player_tick_fraction = 0;
    
        /**
         * CSGOInputHistoryEntryPB cl_interp.
         * @member {ICSGOInterpolationInfoPB_CL|null|undefined} cl_interp
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.cl_interp = null;
    
        /**
         * CSGOInputHistoryEntryPB sv_interp0.
         * @member {ICSGOInterpolationInfoPB|null|undefined} sv_interp0
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.sv_interp0 = null;
    
        /**
         * CSGOInputHistoryEntryPB sv_interp1.
         * @member {ICSGOInterpolationInfoPB|null|undefined} sv_interp1
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.sv_interp1 = null;
    
        /**
         * CSGOInputHistoryEntryPB player_interp.
         * @member {ICSGOInterpolationInfoPB|null|undefined} player_interp
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.player_interp = null;
    
        /**
         * CSGOInputHistoryEntryPB frame_number.
         * @member {number} frame_number
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.frame_number = 0;
    
        /**
         * CSGOInputHistoryEntryPB target_ent_index.
         * @member {number} target_ent_index
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.target_ent_index = -1;
    
        /**
         * CSGOInputHistoryEntryPB shoot_position.
         * @member {ICMsgVector|null|undefined} shoot_position
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.shoot_position = null;
    
        /**
         * CSGOInputHistoryEntryPB target_head_pos_check.
         * @member {ICMsgVector|null|undefined} target_head_pos_check
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.target_head_pos_check = null;
    
        /**
         * CSGOInputHistoryEntryPB target_abs_pos_check.
         * @member {ICMsgVector|null|undefined} target_abs_pos_check
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.target_abs_pos_check = null;
    
        /**
         * CSGOInputHistoryEntryPB target_abs_ang_check.
         * @member {ICMsgQAngle|null|undefined} target_abs_ang_check
         * @memberof CSGOInputHistoryEntryPB
         * @instance
         */
        CSGOInputHistoryEntryPB.prototype.target_abs_ang_check = null;
        ...
        CSGOInputHistoryEntryPB.encode = function encode(message, writer) {
            ...
            if (message.render_tick_fraction != null && Object.hasOwnProperty.call(message, "render_tick_fraction"))
                writer.uint32(/* id 5, wireType 5 =*/45).float(message.render_tick_fraction);
        ...
        CSGOInputHistoryEntryPB.fromObject = function fromObject(object) {
            ...
            if (object.render_tick_fraction != null)
                message.render_tick_fraction = Number(object.render_tick_fraction);
            if (object.player_tick_count != null)
                message.player_tick_count = object.player_tick_count | 0;
        ...
        CSGOInputHistoryEntryPB.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.render_tick_count = 0;
                object.render_tick_fraction = 0;
                object.player_tick_count = 0;
                object.player_tick_fraction = 0;
                object.cl_interp = null;
                object.sv_interp0 = null;
                object.sv_interp1 = null;
                object.player_interp = null;
                object.frame_number = 0;
                object.target_ent_index = -1;
                object.shoot_position = null;
                object.target_head_pos_check = null;
    ...
    $root.CSGOUserCmdPB = (function() {
         ...
         * @property {Array.<ICSGOInputHistoryEntryPB>|null} [input_history] CSGOUserCmdPB input_history
         * @property {number|null} [attack1_start_history_index] CSGOUserCmdPB attack1_start_history_index
         * @property {number|null} [attack2_start_history_index] CSGOUserCmdPB attack2_start_history_index
         * @property {boolean|null} [left_hand_desired] CSGOUserCmdPB left_hand_desired
         * @property {boolean|null} [is_predicting_body_shot_fx] CSGOUserCmdPB is_predicting_body_shot_fx
         * @property {boolean|null} [is_predicting_head_shot_fx] CSGOUserCmdPB is_predicting_head_shot_fx
         * @property {boolean|null} [is_predicting_kill_ragdolls] CSGOUserCmdPB is_predicting_kill_ragdolls
         */
        ...
        /**
         * CSGOUserCmdPB input_history.
         * @member {Array.<ICSGOInputHistoryEntryPB>} input_history
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.input_history = $util.emptyArray;
    
        /**
         * CSGOUserCmdPB attack1_start_history_index.
         * @member {number} attack1_start_history_index
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.attack1_start_history_index = -1;
    
        /**
         * CSGOUserCmdPB attack2_start_history_index.
         * @member {number} attack2_start_history_index
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.attack2_start_history_index = -1;
    
        /**
         * CSGOUserCmdPB left_hand_desired.
         * @member {boolean} left_hand_desired
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.left_hand_desired = false;
    
        /**
         * CSGOUserCmdPB is_predicting_body_shot_fx.
         * @member {boolean} is_predicting_body_shot_fx
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.is_predicting_body_shot_fx = false;
    
        /**
         * CSGOUserCmdPB is_predicting_head_shot_fx.
         * @member {boolean} is_predicting_head_shot_fx
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.is_predicting_head_shot_fx = false;
    
        /**
         * CSGOUserCmdPB is_predicting_kill_ragdolls.
         * @member {boolean} is_predicting_kill_ragdolls
         * @memberof CSGOUserCmdPB
         * @instance
         */
        CSGOUserCmdPB.prototype.is_predicting_kill_ragdolls = false;
        ...
        CSGOUserCmdPB.fromObject = function fromObject(object) {
            ...
            if (object.attack1_start_history_index != null)
                message.attack1_start_history_index = object.attack1_start_history_index | 0;
            if (object.attack2_start_history_index != null)
                message.attack2_start_history_index = object.attack2_start_history_index | 0;
            if (object.left_hand_desired != null)
                message.left_hand_desired = Boolean(object.left_hand_desired);
            if (object.is_predicting_body_shot_fx != null)
                message.is_predicting_body_shot_fx = Boolean(object.is_predicting_body_shot_fx);
            if (object.is_predicting_head_shot_fx != null)
                message.is_predicting_head_shot_fx = Boolean(object.is_predicting_head_shot_fx);
            if (object.is_predicting_kill_ragdolls != null)
                message.is_predicting_kill_ragdolls = Boolean(object.is_predicting_kill_ragdolls);
            return message;
        };
        ...
        CSGOUserCmdPB.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                object.base = null;
                object.attack1_start_history_index = -1;
                object.attack2_start_history_index = -1;
                object.left_hand_desired = false;
                object.is_predicting_body_shot_fx = false;
    ...
    $root.CBaseUserCmdPB = (function() {
        ...
        CBaseUserCmdPB.fromObject = function fromObject(object) {
            ...
            if (object.pawn_entity_handle != null)
                message.pawn_entity_handle = object.pawn_entity_handle >>> 0;
            if (object.subtick_moves) {
                if (!Array.isArray(object.subtick_moves))
            ...
            if (object.move_crc != null)
                if (typeof object.move_crc === "string")
                    $util.base64.decode(object.move_crc, message.move_crc = $util.newBuffer($util.base64.length(object.move_crc)), 0);
                else if (object.move_crc.length >= 0)
                    message.move_crc = object.move_crc;
            if (object.consumed_server_angle_changes != null)
        ...
        CBaseUserCmdPB.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                object.legacy_command_number = 0;
                object.client_tick = 0;
                object.buttons_pb = null;
                ...
                object.mousedx = 0;
                object.mousedy = 0;
                object.pawn_entity_handle = 16777215;
                object.prediction_offset_ticks_x256 = 0;
                if (options.bytes === String)
                    object.move_crc = "";
                else {
                    object.move_crc = [];
                    if (options.bytes !== Array)
                        object.move_crc = $util.newBuffer(object.move_crc);
                }
