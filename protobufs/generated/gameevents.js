...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgClearEntityDecalsEvent = (function() {
         ...
         * @returns {string} The default type url
         */
        CMsgClearEntityDecalsEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgClearEntityDecalsEvent";
        };
    
        return CMsgClearEntityDecalsEvent;
    })();
    
    $root.CMsgClearDecalsForEntityEvent = (function() {
    
        /**
         * Properties of a CMsgClearDecalsForEntityEvent.
         * @exports ICMsgClearDecalsForEntityEvent
         * @interface ICMsgClearDecalsForEntityEvent
         * @property {number|null} [flagstoclear] CMsgClearDecalsForEntityEvent flagstoclear
         * @property {number|null} [entityhandle] CMsgClearDecalsForEntityEvent entityhandle
         */
    
        /**
         * Constructs a new CMsgClearDecalsForEntityEvent.
         * @exports CMsgClearDecalsForEntityEvent
         * @classdesc Represents a CMsgClearDecalsForEntityEvent.
         * @implements ICMsgClearDecalsForEntityEvent
         * @constructor
         * @param {ICMsgClearDecalsForEntityEvent=} [properties] Properties to set
         */
        ...
        /**
         * CMsgClearDecalsForEntityEvent flagstoclear.
         * @member {number} flagstoclear
         * @memberof CMsgClearDecalsForEntityEvent
         * @instance
         */
        CMsgClearDecalsForEntityEvent.prototype.flagstoclear = 0;
    
        /**
         * CMsgClearDecalsForEntityEvent entityhandle.
         * @member {number} entityhandle
         * @memberof CMsgClearDecalsForEntityEvent
         * @instance
         */
        CMsgClearDecalsForEntityEvent.prototype.entityhandle = 16777215;
    
        /**
         * Creates a new CMsgClearDecalsForEntityEvent instance using the specified properties.
         * @function create
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {ICMsgClearDecalsForEntityEvent=} [properties] Properties to set
         * @returns {CMsgClearDecalsForEntityEvent} CMsgClearDecalsForEntityEvent instance
         */
        CMsgClearDecalsForEntityEvent.create = function create(properties) {
            return new CMsgClearDecalsForEntityEvent(properties);
        };
    
        /**
         * Encodes the specified CMsgClearDecalsForEntityEvent message. Does not implicitly {@link CMsgClearDecalsForEntityEvent.verify|verify} messages.
         * @function encode
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {ICMsgClearDecalsForEntityEvent} message CMsgClearDecalsForEntityEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CMsgClearDecalsForEntityEvent message, length delimited. Does not implicitly {@link CMsgClearDecalsForEntityEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {ICMsgClearDecalsForEntityEvent} message CMsgClearDecalsForEntityEvent message or plain object to encode
        ...
        /**
         * Decodes a CMsgClearDecalsForEntityEvent message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
        ...
        /**
         * Decodes a CMsgClearDecalsForEntityEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClearDecalsForEntityEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgClearDecalsForEntityEvent message.
         * @function verify
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgClearDecalsForEntityEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgClearDecalsForEntityEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {CMsgClearDecalsForEntityEvent} message CMsgClearDecalsForEntityEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgClearDecalsForEntityEvent to JSON.
         * @function toJSON
         * @memberof CMsgClearDecalsForEntityEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgClearDecalsForEntityEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    
        /**
         * Gets the default type url for CMsgClearDecalsForEntityEvent
         * @function getTypeUrl
         * @memberof CMsgClearDecalsForEntityEvent
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        CMsgClearDecalsForEntityEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgClearDecalsForEntityEvent";
        };
    ...
    $root.CMsgSource1LegacyGameEventList = (function() {
         ...
         * @returns {string} The default type url
         */
        CMsgSource1LegacyGameEventList.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSource1LegacyGameEventList";
        };
        ...
        CMsgSource1LegacyGameEventList.key_t = (function() {
            ...
            key_t.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/CMsgSource1LegacyGameEventList.key_t";
            };
        ...
        CMsgSource1LegacyGameEventList.descriptor_t = (function() {
            ...
            descriptor_t.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/CMsgSource1LegacyGameEventList.descriptor_t";
            };
    ...
    $root.CMsgSource1LegacyListenEvents = (function() {
         ...
         * @returns {string} The default type url
         */
        CMsgSource1LegacyListenEvents.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSource1LegacyListenEvents";
        };
    ...
    $root.CMsgSource1LegacyGameEvent = (function() {
         ...
         * @property {number|null} [server_tick] CMsgSource1LegacyGameEvent server_tick
         * @property {number|null} [passthrough] CMsgSource1LegacyGameEvent passthrough
         */
        ...
        /**
         * CMsgSource1LegacyGameEvent server_tick.
         * @member {number} server_tick
         * @memberof CMsgSource1LegacyGameEvent
         * @instance
         */
        CMsgSource1LegacyGameEvent.prototype.server_tick = 0;
         ...
         * @instance
         */
        CMsgSource1LegacyGameEvent.prototype.passthrough = 0;
        ...
        CMsgSource1LegacyGameEvent.encode = function encode(message, writer) {
            ...
            if (message.passthrough != null && Object.hasOwnProperty.call(message, "passthrough"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.passthrough);
            return writer;
        };
         ...
         * @returns {string} The default type url
         */
        CMsgSource1LegacyGameEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSource1LegacyGameEvent";
        };
        ...
        CMsgSource1LegacyGameEvent.key_t = (function() {
            ...
            key_t.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/CMsgSource1LegacyGameEvent.key_t";
            };
    ...
    $root.CMsgSosStartSoundEvent = (function() {
         ...
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.source_entity_index = -1;
        ...
        CMsgSosStartSoundEvent.fromObject = function fromObject(object) {
            ...
            if (object.packed_params != null)
                ...
                else if (object.packed_params.length >= 0)
         ...
         * @returns {string} The default type url
         */
        CMsgSosStartSoundEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSosStartSoundEvent";
        };
    ...
    $root.CMsgSosStopSoundEvent = (function() {
         ...
         * @returns {string} The default type url
         */
        CMsgSosStopSoundEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSosStopSoundEvent";
        };
    ...
    $root.CMsgSosStopSoundEventHash = (function() {
         ...
         * @instance
         */
        CMsgSosStopSoundEventHash.prototype.source_entity_index = -1;
         ...
         * @returns {string} The default type url
         */
        CMsgSosStopSoundEventHash.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSosStopSoundEventHash";
        };
    ...
    $root.CMsgSosSetSoundEventParams = (function() {
         ...
         * @returns {string} The default type url
         */
        CMsgSosSetSoundEventParams.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSosSetSoundEventParams";
        };
    ...
    $root.CMsgSosSetLibraryStackFields = (function() {
        ...
        CMsgSosSetLibraryStackFields.fromObject = function fromObject(object) {
            ...
            if (object.packed_fields != null)
                ...
                else if (object.packed_fields.length >= 0)
         ...
         * @returns {string} The default type url
         */
        CMsgSosSetLibraryStackFields.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/CMsgSosSetLibraryStackFields";
        };
