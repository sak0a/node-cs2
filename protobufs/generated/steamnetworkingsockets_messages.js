...
(function(global, factory) { /* global define, require, module */
    ...
    $root.CMsgSteamDatagramSessionCryptInfo = (function() {
        ...
        CMsgSteamDatagramSessionCryptInfo.fromObject = function fromObject(object) {
            ...
            default:
                if (typeof object.key_type === "number") {
            ...
            if (object.key_data != null)
                ...
                else if (object.key_data.length >= 0)
    ...
    $root.CMsgSteamDatagramLinkLifetimeStats = (function() {
         ...
         * @property {number|Long|null} [packets_recv_out_of_order_corrected] CMsgSteamDatagramLinkLifetimeStats packets_recv_out_of_order_corrected
        ...
        /**
         * CMsgSteamDatagramLinkLifetimeStats packets_recv_out_of_order_corrected.
         * @member {number|Long} packets_recv_out_of_order_corrected
         * @memberof CMsgSteamDatagramLinkLifetimeStats
         * @instance
         */
        CMsgSteamDatagramLinkLifetimeStats.prototype.packets_recv_out_of_order_corrected = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        ...
        CMsgSteamDatagramLinkLifetimeStats.encode = function encode(message, writer) {
            ...
            if (message.packets_recv_out_of_order_corrected != null && Object.hasOwnProperty.call(message, "packets_recv_out_of_order_corrected"))
                writer.uint32(/* id 15, wireType 0 =*/120).uint64(message.packets_recv_out_of_order_corrected);
        ...
        CMsgSteamDatagramLinkLifetimeStats.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 15: {
                        message.packets_recv_out_of_order_corrected = reader.uint64();
                        break;
                    }
                case 10: {
        ...
        CMsgSteamDatagramLinkLifetimeStats.fromObject = function fromObject(object) {
            ...
            if (object.packets_recv_out_of_order_corrected != null)
                if ($util.Long)
                    ...
                    message.packets_recv_out_of_order_corrected = object.packets_recv_out_of_order_corrected;
                else if (typeof object.packets_recv_out_of_order_corrected === "object")
    ...
    $root.CMsgICERendezvous = (function() {
         ...
         * @property {ICMsgICECandidate|null} [add_candidate] CMsgICERendezvous add_candidate
         */
         ...
         * @member {ICMsgICECandidate|null|undefined} add_candidate
         * @memberof CMsgICERendezvous
         * @instance
         */
    ...
    $root.CMsgSteamNetworkingP2PRendezvous = (function() {
        ...
        CMsgSteamNetworkingP2PRendezvous.fromObject = function fromObject(object) {
            ...
            if (object.sdr_routes != null)
                ...
                else if (object.sdr_routes.length >= 0)
        ...
        CMsgSteamNetworkingP2PRendezvous.ApplicationMessage = (function() {
             ...
             * @property {number|null} [lane_idx] ApplicationMessage lane_idx
             */
            ...
            /**
             * ApplicationMessage lane_idx.
             * @member {number} lane_idx
             * @memberof CMsgSteamNetworkingP2PRendezvous.ApplicationMessage
             * @instance
             */
            ApplicationMessage.prototype.lane_idx = 0;
            ...
            ApplicationMessage.encode = function encode(message, writer) {
                ...
                if (message.lane_idx != null && Object.hasOwnProperty.call(message, "lane_idx"))
                    writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.lane_idx);
                return writer;
            };
            ...
            ApplicationMessage.fromObject = function fromObject(object) {
                ...
                if (object.lane_idx != null)
                    message.lane_idx = object.lane_idx >>> 0;
                return message;
            };
    ...
    $root.CMsgSteamNetworkingIdentityLegacyBinary = (function() {
        ...
        CMsgSteamNetworkingIdentityLegacyBinary.fromObject = function fromObject(object) {
            ...
            if (object.generic_bytes != null)
                ...
                else if (object.generic_bytes.length >= 0)
            ...
            if (object.ipv6_and_port != null)
                ...
                else if (object.ipv6_and_port.length >= 0)
    ...
    $root.CMsgSteamDatagramCertificate = (function() {
         ...
         * @property {Array.<string>|null} [ip_addresses] CMsgSteamDatagramCertificate ip_addresses
         */
         ...
         * @instance
         */
        CMsgSteamDatagramCertificate.prototype.ip_addresses = $util.emptyArray;
        ...
        CMsgSteamDatagramCertificate.encode = function encode(message, writer) {
            ...
            if (message.ip_addresses != null && message.ip_addresses.length)
                for (var i = 0; i < message.ip_addresses.length; ++i)
                    writer.uint32(/* id 13, wireType 2 =*/106).string(message.ip_addresses[i]);
            return writer;
        };
        ...
        CMsgSteamDatagramCertificate.fromObject = function fromObject(object) {
            ...
            if (object.ip_addresses) {
                if (!Array.isArray(object.ip_addresses))
                    throw TypeError(".CMsgSteamDatagramCertificate.ip_addresses: array expected");
                message.ip_addresses = [];
    ...
    $root.CMsgSteamDatagramCertificateSigned = (function() {
        ...
        CMsgSteamDatagramCertificateSigned.fromObject = function fromObject(object) {
            ...
            if (object.ca_signature != null)
                ...
                else if (object.ca_signature.length >= 0)
            ...
            if (object.private_key_data != null)
                ...
                else if (object.private_key_data.length >= 0)
