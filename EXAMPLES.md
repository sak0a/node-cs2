...
const campaignId = 1;
const redeemId = 123;
// You can get your current balance from cs2.xpShop.redeemable_balance
...
### Listen for XP Shop Balance

```javascript
cs2.on('xpShopUpdate', (xpShop) => {
    if (xpShop) {
        console.log('Current stars balance:', xpShop.redeemable_balance);
